...
function Navigation(props) {
  ...
  return (
    <div>
      <Navbar collapseOnSelect expand="sm" className={classes.Navbar} fixed="top" role="button">
        <Navbar.Brand as="div" onClick={() => props.history.push('/')} className={classes.Brand}>
          <h4>
            {' '}
