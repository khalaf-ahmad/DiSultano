...
import { get_error_message, get_product_form_data } from '../../shared/utility';
...
export function* fetch_product_saga(action) {
    ...
    try {
        ...
        yield put(actions.fetch_products_fail(get_error_message(error)));
    }
}
...
export function* add_product_saga(action) {
    ...
    try {
        ...
        yield put(actions.add_product_fail(get_error_message(error)))
    }
}
...
export function* update_product_saga(action) {
    ...
    try {
        ...
        yield put(actions.update_product_fail(get_error_message(error)))
    }
}
...
export function* delete_product_saga(action) {
    ...
    try {
        ...
        yield put(actions.delete_product_fail(get_error_message(error)))
    }
}
